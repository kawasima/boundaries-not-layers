...
/**
 * raoh 版のエンドツーエンドテスト（実 H2 + jOOQ）。
 *
 * <p>他の3例と同じ外形（成功=201 / 上限=422 / 販売終了=422 / 不正入力=400）を満たしつつ、
 * 追加後に一覧へ出ること（読み取り境界の decoder と応答 encoder）も確認する。
 * 上限は {@link com.example.cart.domain.Cart#UPPER_BOUND} = 10000。
 */
@SpringBootTest
